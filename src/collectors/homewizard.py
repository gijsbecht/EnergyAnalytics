...
class HomeWizardP1Collector(CollectorBase):
    ...
    def _parse(self, data: dict) -> P1Reading:
        ...
        return P1Reading(
            ...
            voltage_l1_v=data.get("active_voltage_l1_v"),
            voltage_l2_v=data.get("active_voltage_l2_v"),
            voltage_l3_v=data.get("active_voltage_l3_v"),
            current_l1_a=data.get("active_current_l1_a"),
            current_l2_a=data.get("active_current_l2_a"),
            current_l3_a=data.get("active_current_l3_a"),
            frequency_hz=data.get("active_frequency_hz"),
            energy_import_t1_kwh=data.get("total_power_import_t1_kwh", 0.0),
            energy_import_t2_kwh=data.get("total_power_import_t2_kwh", 0.0),
            energy_export_t1_kwh=data.get("total_power_export_t1_kwh", 0.0),
            energy_export_t2_kwh=data.get("total_power_export_t2_kwh", 0.0),
        )
